            ...
            <Row>
              <Col alignSelf="start">
                ...
                <Field>
                  ...
                  >
                    <Label style={{ marginTop: 8 }}>Expanded</Label>
                  </Toggle>
                </Field>
              </Col>
              <Col alignSelf="start">
                <Field>
                  <Label style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Button
                      isLink
                      onClick={() =>
                        setState({ color: PALETTE.kale[700], isLight: false, isDark: false })
                      }
                    >
                      Reset
                    </Button>
                  ...
                  <Input
                    ...
                    value={state.color}
                    onChange={e => {
                      const colorLuminance = e.target.value
                        ? getLuminance(e.target.value)
                        : undefined;
      ...
      <Row>
        <Col>
          <Chrome style={{ height: 500 }}>
            ...
            >
              <NavItem isLogo product={state.product} title="Zendesk">
                <NavItemIcon>
              ...
              <NavItem isBrandmark title="Zendesk">
                <NavItemIcon>
                  <ZendeskIcon />
                </NavItemIcon>
